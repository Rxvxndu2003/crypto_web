...
<div id="particles">
    <div id="webcoderskull">
        <div class="hero-section style-two upper d-flex align-items-center" id="home">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="dreamit-hero-thumb wow fadeInDown" data-wow-delay=".">
...
<!--==================================================-->
<div class="feature-area style-two pt-90 pb-80" id="feature">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="feature-bottom-text text-center wow fadeInLeft" data-wow-delay=".6s">
                    <p> <i class="flaticon-light-bulb"></i> Do you Know More? <span><a href="#">Learn More</a></span></p>
                </div>
            </div>    
        </div>
    </div>
...
<!--==================================================-->
<div class="about-area style-two pt-100 pb-100" id="about">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="dreamit-about-thumb wow fadeInLeft" data-wow-delay=".3s">
                    <img src="assets/images/resource/about-main-img.png" alt="">
                    <div class="about-thumb-inner rotateme">
                        <img src="assets/images/resource/about-coin.png" alt="">
                    </div>
                    <div class="about-thumb-inner1 bounce-animate3">
                        <img src="assets/images/resource/about-icon.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="row wow fadeInLeft" data-wow-delay=".4s">
                    ...
                    <div class="col-lg-6">
                        <div class="about-single-icon-box wow fadeInLeft" data-wow-delay=".5s">
                    ...
                    <div class="col-lg-6">
                        <div class="about-single-icon-box wow fadeInLeft" data-wow-delay=".6s">
                            <div class="about-icon">
                    ...
                    <div class="col-lg-6">
                        <div class="about-single-icon-box wow fadeInLeft" data-wow-delay=".7s">
                            <div class="about-icon">
                    ...
                    <div class="col-lg-6">
                        <div class="about-single-icon-box wow fadeInLeft" data-wow-delay=".8s">
                            <div class="about-icon">
...
<div class="services-area style-two pt-90 pb-100">
    <div class="container">
        ...
        <div class="row service-bg wow fadeInLeft" data-wow-delay=".5s">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="service-single-thumb wow fadeInLeft" data-wow-delay=".6s">
                    ...
                    <div class="service-thumb-inner2 bounce-animate5">
                        <img src="assets/images/resource/half-cirlce-green.png" alt="">
                    </div>
...
<!--==================================================-->
<div class="process-area pt-80 pb-70" id="process">
    <div class="container">
        <div class="row">
             <div class="col-lg-12 col-sm-12">
                 <div class="dreamit-section-title text-center style-two pb-5 wow fadeInLeft" data-wow-delay=".3s">
            ...
            <div class="col-lg-12">
                <div class="row process-bg">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-process-box wow fadeInLeft" data-wow-delay=".4s">
                            <div class="single-process-thumb">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-process-box wow fadeInLeft" data-wow-delay=".5s">
                            <div class="single-process-thumb">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-process-box wow fadeInLeft" data-wow-delay=".6s">
                            <div class="single-process-thumb">
...
<!--==================================================-->
<div class="testimonial-area pt-100 pb-70" id="testimonial">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="testimonial-counter-thumb wow fadeInLeft" data-wow-delay=".4s">
                    <div class="counter-thumb">
                        <img src="assets/images/resource/testi.png" alt="">
                    </div>
                    <div class="testimonial-counter-title">
                        <h3 class="counter">3120 <span>+</span></h3>
...
<div class="subscribe-area pt-100 pb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="single-subscribe-box wow fadeInLeft" data-wow-delay=".3s">
                    ...
                    <div class="contact-form-box-2 text-center wow fadeInLeft" data-wow-delay=".4s">
                        <form action="https://formspree.io/f/myyleorq" method="POST" id="dreamit-form">
                            <div class="from-box2">
